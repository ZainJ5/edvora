...
const WebDevelopmentCourses = () => {
  ...
  useEffect(() => {
    const fetchWebDevCourses = async () => {
      try {
        const response = await fetch('/api/web-development-courses');
        ...
        console.error('Failed to fetch Web Development courses:', error);
      } finally {
        setLoading(false);
      }
    };
    ...
    <section className="bg-white py-12 text-black">
      <div className="container mx-auto px-4">
        <div className="mb-8">
          ...
          >
            Master the skills needed to build modern, responsive websites
          </motion.p>
          
          <div className="flex justify-end">
            <Link href="/courses?category=Web%20Development" className="text-blue-600 hover:underline">
              View All
            </Link>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {courses.length > 0 ? (
              ...
              >
                ...
                <div className="p-4">
                  ...
                  <div className="flex items-center mt-3">
                    ...
                    <button className="ml-auto bg-[#235d96] text-white px-4 py-1.5 rounded hover:bg-[#1d4975] transition">
                      View Details
                    </button>
                  </div>
            ...
            <div className="col-span-3 text-center py-10">
              <p>No Web Development courses found. Check back later!</p>
            </div>
          )}
        </div>
      </div>
